...
//    }
     ...
     */
    public function test_default_browser_accept_headers($accept)
    {
        $negotiator = new AcceptHeaderNegotiator('*/*');
        $negotiator = new AcceptHeaderNegotiator('application/json, application/xml');
        var_export($negotiator->matches($accept)); exit;
    }
